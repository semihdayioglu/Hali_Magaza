...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="h-full px-4 md:px-16 py-4 md:py-0 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0">
        {/* Logo */}
        <Link 
          to="/" 
          data-testid="logo"
        ...
        {/* Sağ Menü İkonları - Desktop (Sadece İkonlar, Text Yok) */}
        ...
        >
          ...
          <div className="flex justify-around">
            ...
            >
              ...
              <span className="text-xs text-gray-600">Kargo</span>
            </Link>
            <Link 
              to="/favoriler" 
              onClick={() => setMobileMenuOpen(false)}
            ...
            >
              <div className="p-3 bg-gray-100 rounded-full relative">
                ...
                {getFavoritesCount() > 0 && (
                  <span className="absolute -top-1 -right-1 w-5 h-5 bg-[#4A7C4E] text-white text-xs rounded-full flex items-center justify-center font-semibold">
                    {getFavoritesCount()}
                  </span>
                )}
              </div>
            ...
            >
              ...
              <span className="text-xs text-gray-600">Sepet</span>
            </Link>
          </div>
        </div>
      )}
